...
def registrar_log(mensagem):
    with open("log_execucaoelevenlabsturbo.txt", "a", encoding="utf-8") as log:
...
def processar_audio(file_path):
    ...
    try:
        ...
        translated = GoogleTranslator(source='auto', target=codigo_idioma, encoding="utf-8").translate(transcricao)
